  ...
  return (
    <section id="moreabout" ref={ref}>
      ...
      <body className="MoreAbout">
        <h3>About Me</h3>
        <p>Hi! My name is Anshi Mathur and I am currently a Senior at the University of Illinois at Urbana-Champaign! I am also currently a Data Science intern at Bayer!!</p>
